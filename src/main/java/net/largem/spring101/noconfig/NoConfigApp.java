...
/**
 * This module is to demonstrate how annotation helps to create beans
 * No XML or Java configuation is needed.
 */
...
@ComponentScan
//@ComponentScan({"net.largem.spring101.noconfig")
//Not sure if it is the recommended way to use net.largem.spring101.noconfig.application.properties which is not identified as a Spring Application
//properties (in Spring Boot, net.largem.spring101.noconfig.application.properties will be picked up automatically).
